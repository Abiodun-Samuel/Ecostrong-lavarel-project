    ...
    <section id="contact-page" class="contact section-bg">
        <div class="container" data-aos="fade-up">
            ...
            <div class="section-title">
                ...
                <p>
                    Build Your Brand | Get New Business Opportunities | New Properties
                </p>
            </div>

            <div class="row my-3" data-aos="fade-up" data-aos-duration="500">
                            ...
                            <div class="contact">
                                <div class="form">
                                    ...
                                    <form action="{{ route('contact.send') }} "
                                        enctype="application/x-www-form-urlencoded" method="POST" role="form"
                                        class="contactForm">
                                        @csrf
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-lg-6">
                                                <input type="text" name="name" class="form-control" id="name"
                                                    placeholder="Name" minlength="4" value="{{ old('name') }}" required />
                                            ...
                                            <div class="form-group col-lg-12">
                                                <textarea class="form-control" name="message" rows="4"
                                                    placeholder="Enter Your Message Here..." value="{{ old('message') }}"
                                                    required></textarea>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <button class="mx-2" type="reset" value="">
                                                Clear
                                            </button>
                                        </div>
                                    </form>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="contact-icons">
                                {{-- WhatsApp --}}
                                <a href="https://wa.me/message/YOIQUX7K2UQBH1">
                                    <i>
                                ...
                                {{-- facebook --}}
                                <a href="https://m.facebook.com/ecostrongrealestate/">
                                    <i>
                                ...
                                {{-- instagram --}}
                                <a href="https://www.instagram.com/ecostrongcompany/">
                                    <i>
                                ...
                                {{-- linkedin --}}
                                <a href="https://www.linkedin.com/company/ecostrong-company-limited">
                                    <i>
                                ...
                                {{-- mail --}}
                                <a href="mailto:contact@ecostrongcompany.com.ng">
                                    <i>
                            ...
                            <div style="width: 100%">
                                <iframe width="100%" height="125" frameborder="0" scrolling="no" marginheight="0"
                                    marginwidth="0"
                                    src="https://maps.google.com/maps?width=100%25&amp;height=200&amp;hl=en&amp;q=Ekotedo%20Iya-Olobe%20Road%20Dugbe%20Ibadan.%20Oyo%20state%20Nigeria+(Ecostrong%20Limited)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed">
                                </iframe>
                            </div>
            ...
            <div class="row" data-aos="fade-up" data-aos-duration="300">
                ...
                <div class="col-lg-6">
                    <div class="info-box mb-4">
                        ...
                        <h3>Our Address</h3>
                        <p> Suite 12, Saf City Complex, Ekotedo Iya-Olobe Road Dugbe Ibadan. Oyo state Nigeria
                            <br>
                            P.O Box: 200281.
                        </p>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="info-box mb-4">
                        ...
                        <h3>Email Us</h3>
                        <p>contact@ecostrongcompany.com.ng</p>
                        <p>info@ecostrongcompany.com.ng</p>
